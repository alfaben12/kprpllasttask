<h3 class="page-title">Tambah Baru Pembelian</h3>
...
<div class="row">
	<div class="col-md-12">
			...
			<div class="panel-body">
				<table width="100%">
					<tr>
						...
						<td>&nbsp;</td>
						<td>
							<input class="form-control" placeholder="Jumlah" id="txt_jumlah" name="txt_jumlah" size="4">
						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>
							<input type="text" class="form-control" placeholder="Harga" id="txt_harga" name="txt_harga" size="10">
		...
		<div class="panel">
			<div class="panel-heading">
				<h3 class="panel-title">Result Pembelian</h3>
			</div>
			<div class="panel-body">
